          ...
          <div className="eventbox mt-8 sm:mt-0 sm:absolute top-0 right-0 h-[460px] w-[280px] sm:w-[380px] bg-[#1c1c24] border border-[#252d3c] rounded-md p-4">
            ...
            <div className="flex py-2 items-center gap-4">
              ...
              <div className="text inline">
                ...
                <p className="text-sm my-2 cursor-pointer text-[#51adc4]">
                  View On Map
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="bg-[#292932] h-8 w-8 rounded-md hover:bg-[#51adc4]"
                >
            ...
            <button
              ...
              className="bg-[#51adc4] w-full p-2 rounded-md font-semibold cursor-pointer"
            >
